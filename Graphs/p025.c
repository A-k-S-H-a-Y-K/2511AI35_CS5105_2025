...
int courseScheduleII(int courseCount, int **prerequisiteList, int prereqCount, int *resultArr) {
    ...
    while (fIdx < qIdx) {
        ...
        resultArr[resultIdx++] = currCourse;
...
int main() {
    ...
    int result[4];
    courseScheduleII(4, pPtr, 3, result);
